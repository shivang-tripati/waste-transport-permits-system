      ...
      <div className="w-full max-w-2xl text-center space-y-12">
        ...
        <div className="space-y-6 max-w-md mx-auto">
          <div className="space-y-2">
            <h3 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Resource Unavailable</h3>
            <p className="text-slate-500 font-medium">
              The page or permit you're looking for cannot be found.
            </p>
          </div>
        ...
        <footer className="pt-12">
          <div className="inline-flex items-center gap-3 px-6 py-2 bg-white/80 backdrop-blur-md rounded-full border border-slate-200 shadow-sm">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">
              Reference: Resource Not Found in Registry
            </span>
          </div>
        </footer>
      </div>
